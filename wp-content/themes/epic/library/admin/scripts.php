...
function al_admin_scripts() {
	...
	// Admin Stylesheet
	wp_enqueue_style('Epic-admin-styles',get_template_directory_uri(). '/library/admin/css/admin.css', false, '1.0.0', 'screen');
	wp_enqueue_style('Epic-colorpicker', get_template_directory_uri(). '/library/admin/css/colorpicker.css', false, '1.0.0', 'screen');
	wp_enqueue_style('Epic-datetime', get_template_directory_uri(). '/library/admin/css/datetime.css', false, '1.0.0', 'screen');

	
	// JAVASCRIPT
	wp_enqueue_script( 'jquery-ui-sortable' );
	wp_enqueue_script('Epic-admin', get_template_directory_uri() . '/library/admin/js/admin.js', array('jquery'), '1.0.0');
	...
	wp_enqueue_script('Epic-filestyle', get_template_directory_uri() . '/library/admin/js/filestyle.js', array('jquery'), '1.0.0');
}
