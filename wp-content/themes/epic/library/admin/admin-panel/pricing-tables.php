...
function al_pricing_tables_scripts($hook) {
	...
	if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'pricing_tables') {
		...
		// JAVASCRIPT
		//wp_enqueue_script('al-pricing-tables', get_bloginfo('stylesheet_directory') . '/library/admin/js/ZeroClipboard.js', array('jquery'), '1.0.4');
	}
}
...
function pricing_tables()
{
	...
	<div id="header">
        <div id="logo-container">
			<h1><img src="<?php echo get_template_directory_uri()?>/library/admin/images/main_logo.png" alt="Epic" /></h1>		
        </div>	
        <div id="admin-panel">
		      	...
		      	<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?page=pricing_tables&amp;action=<?php echo $wizard->getStepName() ?>" id="custom" class="form">
			        ...
			        <fieldset class="step">
				        ...
				        <div style="float:left; width:300px">
				    		...
				    		<label for="style1" style="display:inline; width:122px; margin-top:0px">Style 1 (Dark version)</label> 
				        ...
				        <div style="float:right; width:300px; border-left:dotted 1px #ccc; padding-left:80px">
				        	<p><img src="<?php echo get_template_directory_uri()  ?>/library/admin/images/pricing-tables/table2.png"  alt="Style1" /> </p>
				       		<label for="style2" style="display:inline; width:122px; margin-top:0px">Style 2 (Light version)</label> 
				       		<input type="radio" style="width:20px; padding-top:10px" id="style2" name="style" value="style2" <?php if ($wizard->getValue('style') == 'style2'):?>checked="checked"<?php endif?> />
				        </div>
				        <div class="clear"></div>  
			        </fieldset>
