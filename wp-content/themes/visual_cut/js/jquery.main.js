...
function initCarouselHeight() {
	function carouselSameHeight() {
		var height = jQuery('#main-gallery .item.active').find('.img-holder').height();
		jQuery('#main-gallery').find('.carousel-control').height(height);
		jQuery('#main-gallery').find('.carousel-caption').height(height);
	}
